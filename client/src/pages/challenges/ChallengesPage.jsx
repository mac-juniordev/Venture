      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">
            Challenges advertised by VENTURE. Join, compete, and claim your glory.
          </p>
        </div>
        <Link
          to="/my-challenges"
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 font-medium rounded-xl transition-all text-sm shadow-sm"
        >
      ...
      <div className="space-y-3">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-2.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-xl text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:border-sky-400 dark:focus:border-sky-500 focus:ring-2 focus:ring-sky-100 dark:focus:ring-sky-900/30 transition-all"
          />
        </div>
              ...
              <button
                ...
                className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-all flex items-center gap-1.5 ${
                  category === cat.value
                    ...
                    : 'bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 text-gray-500 dark:text-gray-400 hover:border-gray-300 dark:hover:border-gray-600'
                }`}
              >
        ...
        >
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm mb-6 max-w-md mx-auto">
            {searchTerm 
              ...
              : 'No challenges available right now. Check back soon — admins are preparing something epic.'}
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            {searchTerm && (
              <button
                onClick={() => setSearchTerm('')}
                className="px-6 py-2.5 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 font-medium rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors text-sm"
              >
                Clear Search
              </button>
            )}
            <Link
              to="/my-challenges"
              className="px-6 py-2.5 bg-gradient-to-r from-sky-400 to-emerald-400 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-sky-200 dark:shadow-sky-900/30 text-sm inline-flex items-center justify-center gap-2"
            >
              <Swords className="w-4 h-4" />
              View My Challenges
            </Link>
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <span className={`px-2.5 py-1 rounded-lg text-xs font-medium ${getStatusBadge(challenge.status)}`}>
                      {challenge.status}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-1.5 mb-2">
                    <span className="text-xs text-sky-500 dark:text-sky-400 font-medium capitalize">
                      {challenge.category}
                    </span>
                  </div>

                  {/* Title */}
                  <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2 line-clamp-2 group-hover:text-sky-500 dark:group-hover:text-sky-400 transition-colors">
                    {challenge.title}
                  </h3>
